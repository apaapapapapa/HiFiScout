...
DROP TRIGGER IF EXISTS trg_shop_sync_state_legacy_dispatch_insert;
DROP TRIGGER IF EXISTS trg_shop_sync_state_legacy_dispatch_update;
DROP TRIGGER IF EXISTS trg_shop_sync_state_dispatch_legacy_insert;
DROP TRIGGER IF EXISTS trg_shop_sync_state_dispatch_legacy_update;
