...
const CATEGORY_NAMES =
  "スピーカーアクセサリー|スピーカーユニット|スピーカー|フルレンジユニット|ドライバーユニット|スーパーツイーター|ツイーター|ウーファーユニット|ホーン|エンクロージャー|チャンネルデバイダー|チャンネルディバイダー|イコライザー|チューナー|カセットデッキ|テープデッキ|オープンリール|DATデッキ|DCCデッキ|MDデッキ|LDプレーヤー|コントロールアンプ|プリアンプ|プリメインアンプ|パワーアンプ|AVアンプ|ヘッドホンアンプ|レコードプレーヤー|CDトランスポート|SACDトランスポート|CDプレーヤー|SACD(?:\\/CD)?プレーヤー|D\\/Aコンバータ(?:ー)?|DAコンバータ(?:ー)?|ネットワークプレーヤー|ネットワークプレイヤー|ネットワークトランスポート|トーンアーム|カートリッジ|昇圧トランス|フォノイコライザー|ヘッドホン|イヤホン|ケーブル|アクセサリー|インシュレータ(?:ー)?|真空管|ラック|その他オーディオ機器";
...
export const HIFIDO_CATEGORY_MAPPING = Object.freeze({
  チューナー: "SRC.TUNER",
  チャンネルデバイダー: "PRC.PROCESSOR",
  チャンネルディバイダー: "PRC.PROCESSOR",
  イコライザー: "PRC.PROCESSOR",
  カセットデッキ: "ANA.TAPE",
  テープデッキ: "ANA.TAPE",
  オープンリール: "ANA.TAPE",
  DATデッキ: "ANA.TAPE",
