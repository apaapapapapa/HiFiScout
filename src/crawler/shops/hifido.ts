...
const CATEGORY_NAMES =
  "オープンリールテープ|カセットテープ|録音用テープ|空リール|仮想アース|スピーカーアクセサリー|スピーカーユニット|スピーカー|フルレンジユニット|ドライバーユニット|ドライバー|スーパーツイーター|ツイーター|ウーファーユニット|ホーン|エンクロージャー|チャンネルデバイダー|チャンネルディバイダー|イコライザー|チューナー|カセットデッキ|テープデッキ|オープンリール|DATデッキ|DCCデッキ|MDデッキ|LDプレーヤー|DVDプレーヤー|コントロールアンプ|プリアンプ|プリメインアンプ|パワーアンプ|AVアンプ|ヘッドホンアンプ|レコードプレーヤー|CDトランスポート|SACDトランスポート|CDプレーヤー|SACD(?:\\/CD)?プレーヤー|D\\/Aコンバータ(?:ー)?|DAコンバータ(?:ー)?|ネットワークプレーヤー|ネットワークプレイヤー|ネットワークトランスポート|トーンアーム|カートリッジ|昇圧トランス|フォノイコライザー|ヘッドホン|イヤホン|ケーブル|アクセサリー|インシュレータ(?:ー)?|真空管|ラック|その他オーディオ機器";
