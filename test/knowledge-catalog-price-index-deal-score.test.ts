...
function dealScore(sqlite: ReturnType<typeof migratedSqlite>["sqlite"], entityKey = "c-990063") {
  return sqlite
...
test("0063 migration persists and incrementally refreshes catalog deal scores", () => {
  ...
  sqlite.exec(`
    INSERT INTO knowledge_catalog_products(
      ...
      990063, 'deal-score-test', 'MODEL-0063', 'model0063', 'Deal Score Test MODEL-0063',
    ...
    ) VALUES ('c-990063', 'catalog', 990063, NULL, 70000, 80000);
  `);
  ...
  sqlite.exec(`
    ...
    ) VALUES (990063, 4, 100000, 90000, 120000, '2026-08-28T00:00:00.000Z');
  `);
  ...
  sqlite.exec(`
    ...
    WHERE catalog_product_id = 990063;
  `);
  ...
  sqlite.exec("DELETE FROM knowledge_catalog_price_indexes WHERE catalog_product_id = 990063");
