...
test('generic official-site adapter discovers a same-origin product link and verifies it', async () => {
  const pages = new Map([
    ['https://example.com/catalog', '<html><body><a href="/products/ABC-1.html">ABC-1</a><a href="https://outside.example/ABC-1.html">outside</a></body></html>'],
    ['https://example.com/products/ABC-1.html', `<html><head><title>ABC-1 Power Amplifier</title>
