...
test('Shimamusen parser extracts products, price and listing kind', () => {
  const items = parseShimamusenListing(listingHtml, { url: 'https://www.shimamusen.com/shopbrand/063/Y/', kind: '展示処分品' });
  ...
  assert.equal(display.sourceUrl, 'https://www.shimamusen.com/shopdetail/000000019689/063/Y/page1/order/');
});
