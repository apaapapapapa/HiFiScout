...
test('Audio Union reconciles manufacturer and model candidates independent of link order', () => {
  ...
  assert.deepEqual({ manufacturer: luxman.manufacturer, model: luxman.model }, { manufacturer: 'LUXMAN', model: 'LMC-5' });
  assert.deepEqual({ manufacturer: denon.manufacturer, model: denon.model }, { manufacturer: 'DENON', model: 'DP-500M' });
  assert.deepEqual({ manufacturer: thorens.manufacturer, model: thorens.model }, { manufacturer: 'Thorens', model: 'TD520RW 3012R' });
