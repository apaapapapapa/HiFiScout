...
eight D1 binding calls by default, and thirty-nine (up to eight targeted-discovery calls plus one
claim and thirty execution calls) for the non-checkpointed data-quality remediation sweep. When
fewer calls remain, the task stays unclaimed
