...
test("market detail displays observation context and scrollable tables on mobile", async ({
  page,
  catalogPage,
}) => {
    ...
    current_conditions: [
      {
        ...
        last_observed_at: "2026-09-07T00:00:00.000Z",
        condition: "used",
        sale_unit: "pair",
      },
    ],
  ...
  await routeProductDetail(page, () => {
    detailRequests++;
    return { product: product({ market_analysis: analysis }), offers: [offer()] };
  });
